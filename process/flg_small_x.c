...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/04 10:45:33 by igearhea          #+#    #+#             */
/*   Updated: 2021/01/04 10:45:34 by igearhea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		flg_small_x_print_right(t_printf_list *printf_list, char *str,
																	int len)
{
	int	i;
...
void		flg_small_x_print_left(t_printf_list *printf_list,
															char *str, int len)
{
	int	i;
...
void		flg_small_x(t_printf_list *printf_list)
{
	...
	if ((num == 0) && (printf_list->no_precision == 0) &&
		...
		flg_small_x_print_left(printf_list, str_after_prec, len);
	else
		flg_small_x_print_right(printf_list, str_after_prec, len);
	free(str_after_prec);
}
